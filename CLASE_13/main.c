...
int main()
{
    ...
    pantalla_altaForzada(array,QTY,"Barracas","Montes de Oca 150",5000,1);
    pantalla_altaForzada(array,QTY,"Barracas","Gabriel 150",6,1);
    pantalla_altaForzada(array,QTY,"Barracas","Carlos 150",5,1);
    ...
    do
    {
        getValidInt("\n\n1.Alta\n2.Baja\n3.Modificar\n4.Mostrar\n5.Ordenar\n6.Mostrar Debug\n7.Contratar\n8-Ordenar pantallas por Precio y Nombre\n9-Pantallas con valor menor o igual a 10\n10.Salir\n","\nNo valida\n",&menu,1,10,1);
        switch(menu)
        {
            case 1:
            ...
            case 8:
                printf("\nLISTAR\n");
                pantalla_mostrar2(array,QTY);
                break;
            case 9:
                printf("\nPRECIOS MENORES A 10\n");

                informar_pantallasValorMenor(array, QTY);
                break;
        }
