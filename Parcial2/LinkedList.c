...
LinkedList* ll_newLinkedList(void)
{
    ...
    return this;
    /*
        -Estos para añadir un nuevo Nodo-
...
LinkedList* ll_filter(LinkedList* this, int (*pFunc)(void*), int criterion)
{
    ...
    int i;
    int size = ll_len(this);
    if(this != NULL && pFunc != NULL && (criterion == 0 || criterion == 1))
    {
        for(i = 0; i < size; i++)
        {
            pElement = ll_get(this, i);
            if((pFunc(pElement) == -1 && criterion == 0) || (pFunc(pElement) == 1 || criterion == 1))
            {
...
void ll_startIter(LinkedList* this)
{
    if(this != NULL)
    {
        this->startNode = this->pFirstNode;
    }
}
...
{
    void* returnAux;
    returnAux = this->startNode;
    if(this->startNode != NULL)
    {
       this->startNode = this->startNode->pNextNode;
    }
...
int ll_count(LinkedList* this,int (*Func)(void*, int),int max)
{
    void* pElement;
    int i;
    int size = ll_len(this);
